  ...
  <div id="contenedor">
        <v-card class="table" elevation="4">
          <v-toolbar flat elevation="4">
            <v-card class="icon">
                <v-icon style="margin-left:30px; margin-top:25px" color="white" x-large="">mdi-file-star-outline</v-icon>
            </v-card>
            ...
            <v-container grid-list-md>
              <v-layout wrap>
                <v-flex xs12 sm12 md612>
                  <v-text-field v-model="editedItem.cedula" label="Cedula" mask="#############"  prepend-icon="mdi-account-box-outline"></v-text-field>
                </v-flex>
                <v-flex xs12 sm12 md12>
                  <v-text-field v-model="editedItem.nombre" label="Nombre" prepend-icon="mdi-account"></v-text-field>
                </v-flex>
                <v-flex xs12 sm12 md12>
                  <v-menu
                    v-model="fechaI"
                ...
                <v-flex xs12 sm8 md8>
                  <br>
                  <v-subheader style="font-size:17px; text-align:left">¿En su puesto de trabajo cuentan con gel antibacterial?</v-subheader> 
                </v-flex>
                <v-flex xs12 sm4 md4>
                ...
                <v-flex xs12 sm8 md8>
                  <br>
                  <v-subheader style="font-size:17px; text-align:left">¿En su puesto de trabajo cuenta con desinfectante para superficies?</v-subheader> 
                </v-flex>
                <v-flex xs12 sm4 md4>
                ...
                <v-flex xs12 sm8 md8>
                  <br>
                  <v-subheader style="font-size:17px; text-align:left">¿Los elementos de protección (tapabocas en tela antifluido y careta protectora) estan en buen estado?</v-subheader> 
                </v-flex>
                <v-flex xs12 sm4 md4>
                ...
                <v-flex xs12 sm8 md8>
                  <br>
                  <v-subheader style="font-size:17px; text-align:left">Afirmo, que he desinfectado  mi puesto de trabajo inclyendo odas las superficies como minimo cada 3 horas</v-subheader> 
                </v-flex>
                <v-flex xs12 sm4 md4>
                ...
                <v-flex xs12 sm8 md8>
                  <br>
                  <v-subheader style="font-size:17px; text-align:left">Afirmo, que he realizado el protocolo de lavado de manos minimo cada 3 horas</v-subheader> 
                </v-flex>
                <v-flex xs12 sm4 md4>
                ...
                <v-flex xs12 sm12 md12>
                  <v-text-field v-model="editedItem.puntoV" label="Punto de Venta/Area donde Labora" prepend-icon="mdi-shield-home-outline"></v-text-field>
                </v-flex>
              </v-layout>
            </v-container>
          </v-card-text>
          ...
          <v-card-actions>
            ...
            <v-btn
              color="grey"
              @click="save"
              :disabled="!editedItem.cedula ||  !editedItem.nombre || !editedItem.fechaExpedicion || !editedItem.temperatura || !editedItem.puntoV"
            >Guardar</v-btn>
          </v-card-actions>
          ...
          >
          {{ text }}
          <v-btn color="#111c3d" depressed @click="snackbar = false">Cerrar</v-btn>
          </v-snackbar>
        </v-card>
...
export default {
  ...
  save(){
    ...
    // se crea el usuario
    axios
      .get(`${env.endpoint}temperatura/create_temperatura?temperatura=${temperatura}`)
      .then(res => {
